...
{
	//-------------------------------------------------------------------------
	public class TeleportAreaNoMaterial : TeleportMarkerBase
	{
		//Public properties
...
#if UNITY_EDITOR
	//-------------------------------------------------------------------------
	[CustomEditor( typeof( TeleportAreaNoMaterial ) )]
	public class TeleportAreaEditor : Editor
	{
		...
		void OnEnable()
		{
			...
			{
				TeleportAreaNoMaterial teleportArea = Selection.activeTransform.GetComponent<TeleportAreaNoMaterial>();
